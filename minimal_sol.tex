...
\begin{lem} \label{lem:imp}
 \begin{enumerate}[1.]
  \item $H_0^1(\Omega)$の原点の近傍$U$と
        $\lambda_0 > 0$が存在して、$0 < \lambda \leq \lambda_0$に対し、
...
\begin{proof}
 ...
 \]
 したがって、\eqref{eq:u_n+1_weaksol}で$n \to \infty$とすると、
 次を得る。
 \begin{equation}
  \int_\Omega (Du \cdot D\psi + a u \psi) dx 
 ...
 \begin{enumerate}
  ...
  \item $u_\lambda \in S_\lambda$より、
        ...
        \begin{align*}
         ...
         \right\|_{H_0^1(\Omega)}
        \end{align*}
        である。ここで、$C^\prime, C^{\prime\prime} > 0$は、
...
\begin{proof}
 ...
 \]
 である。ゆえに、\ref{eq:psi_n_L^q}と合わせて、以下が成立する。
 \[
  \mu_1 \geq \int_\Omega \left( \lvert D\phi_1 \rvert^2 + a \lvert
 \phi_1 \rvert^2
 \right) dx
 \]
 また、$g_0 \in L^{p+1}(\Omega)$より、$b (g_0)^{p-1} \in
 L^{N/2} (\Omega)$より、以下が成立する。
 \[
...
\begin{proof}
補題~\ref{lem:imp}により、$\lambda_0 > 0$が存在して、$0 < \lambda <
